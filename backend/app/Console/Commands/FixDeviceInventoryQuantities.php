...
class FixDeviceInventoryQuantities extends Command
{
    /**
     * The name and signature of the console command.
     */
    protected $signature = 'device-inventory:fix-quantities';

    /**
     * The console command description.
     */
    protected $description = 'Fix device inventory quantity inconsistencies';
