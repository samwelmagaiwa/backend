...
class JeevaModule extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsToMany(UserAccess::class, 'jeeva_modules_selected', 'module_id', 'user_access_id')
                    ->withTimestamps();
    }
