...
class UserJeevaFormRequest extends FormRequest
{
    /**
    ...
    public function failedAuthorization()
    {
        return response()->json([
            'success' => false,
            'message' => 'You are not authorized to submit Jeeva access requests.',
            'error' => 'Only staff members can submit Jeeva access requests.'
        ], 403);
    }
}