...
class UserInternetAccessFormRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'purpose.required' => 'Internet access purpose is required.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'purpose' => 'Internet Access Purpose',
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'purpose' => $this->cleanPurpose($this->purpose),
        ]);
    }
    ...
    public function failedAuthorization()
    {
        return response()->json([
            'success' => false,
            'message' => 'You are not authorized to submit Internet access requests.',
            'error' => 'Only staff members can submit Internet access requests.'
        ], 403);
    }
}