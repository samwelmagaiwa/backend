...
return new class extends Migration
{
    ...
    {
        Schema::create('wellsoft_modules_selected', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_access_id')->constrained('user_access')->onDelete('cascade');
            $table->foreignId('module_id')->constrained('wellsoft_modules')->onDelete('cascade');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('wellsoft_modules_selected');
    }
};