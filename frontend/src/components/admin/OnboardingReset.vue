            ...
            <div class="p-6 space-y-6">
                      ...
                      <div>
                        ...
                        <div class="relative">
                          ...
                          >
                            ...
                            <option value="head_of_department" class="bg-gray-800 text-white">
                              Head of Department
                            </option>

                            <option value="ict_officer" class="bg-gray-800 text-white">
                              ICT Officer
                            </option>
                            <option value="ict_director" class="bg-gray-800 text-white">
                              ICT Director
                            </option>
                            <option value="divisional_director" class="bg-gray-800 text-white">
                              Divisional Director
                            </option>
                          </select>
                          <div
              ...
              >
                ...
                <div v-else-if="error" class="text-center py-8">
                  <div
                    class="bg-red-500/20 border border-red-400/40 rounded-xl p-6 backdrop-blur-sm"
                  >
        ...
        <div class="p-6 text-center body-shadow">
          ...
          >
            <div class="flex items-center justify-center space-x-4">
              <div
                v-if="confirmData.type === 'terms' || confirmData.type === 'both'"
      ...
      const showNotification = (message, type = 'info') => {
        ...
        <div class="flex items-center">
          <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mr-3">
            <i class="fas ${
              type === 'success' ? 'fa-check' : type === 'error' ? 'fa-times' : 'fa-info'
            } text-sm"></i>
          </div>
