  ...
  <div class="flex flex-col h-screen">
          ...
          <div class="absolute inset-0">
            ...
            >
              <i
                :class="[
                  'fas',
                  ['fa-building', 'fa-user-tie', 'fa-crown', 'fa-sitemap', 'fa-users-cog'][
            ...
            <div class="p-6 space-y-6">
                    ...
                    <div class="flex items-center space-x-3">
                      ...
                      <div>
                        <div class="text-2xl font-bold text-white">
                          {{ departmentStatistics.total_departments || 0 }}
                        </div>
              ...
              >
                <div class="flex items-center justify-between mb-6">
                  <div class="flex items-center space-x-4">
                    ...
                    <h3 class="text-xl font-bold text-white flex items-center">
                      ...
                      Departments and HOD Assignments ({{ departmentsPagination.total || 0 }} total
                      departments)
                    </h3>
                  </div>
                  <div class="flex items-center space-x-3">
                    ...
                    >
                      <i
                        :class="departmentsLoading ? 'fas fa-spinner fa-spin' : 'fas fa-refresh'"
                      ></i>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      >
                        ...
                        <option value="assigned" class="bg-gray-800 text-white">With HOD</option>
                        <option value="unassigned" class="bg-gray-800 text-white">
                          Without HOD
                        </option>
                      </select>
                      <div
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-3 h-12">
                      ...
                      />
                      <label class="text-sm text-teal-100"> Active Only </label>
                    </div>
                  </div>
                </div>

                <!-- Departments List -->
                <div v-if="departmentsWithHodsLoading" class="text-center py-8">
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div
                    v-for="department in allDepartmentsWithHods"
                    :key="department.id"
                  ...
                  >
                    <div class="flex items-start justify-between mb-4">
                      <div class="flex items-center space-x-3 flex-1">
                        ...
                        <div class="flex-1">
                          ...
                          <p class="text-teal-100 text-sm">Code: {{ department.code }}</p>
                    ...
                    <!-- Current HOD -->
                    <div class="mb-4">
                      <div class="text-xs text-teal-100 mb-2">Current HOD:</div>
                      <div
                        v-if="department.hod"
                        class="bg-blue-500/20 rounded-lg p-3 border border-blue-400/30"
                      >
                        <div class="flex items-center space-x-3 mb-2">
                          ...
                          <div class="flex-1">
                            ...
                            <p class="text-blue-100 text-xs">{{ department.hod.email }}</p>
                            <p v-if="department.hod.pf_number" class="text-blue-200 text-xs">
                              PF: {{ department.hod.pf_number }}
                            </p>
                          </div>
                        </div>
                        <div
                          v-if="department.hod.roles && department.hod.roles.length > 0"
                          class="flex flex-wrap gap-1"
                        >
                          <span
                            v-for="role in department.hod.roles"
                            :key="role"
                            class="px-2 py-1 bg-blue-600/30 text-blue-100 rounded text-xs border border-blue-400/50"
                          >
                            {{ role }}
                          </span>
                        </div>
                      ...
                      <div
                        v-else
                        class="bg-orange-500/20 rounded-lg p-3 border border-orange-400/30 text-center"
                      >
                        <div class="flex items-center justify-center space-x-2">
                          <i class="fas fa-exclamation-triangle text-orange-300"></i>
                          <span class="text-orange-100 text-sm font-medium">No HOD Assigned</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Pending Requests -->
                    <div class="mb-4">
                      <div class="text-xs text-teal-100 mb-1">Pending Requests:</div>
                      <span
                        :class="[
                          'px-3 py-1 rounded-full text-sm',
                          department.pending_requests_count > 0
                            ? 'bg-red-500/30 text-red-100 border border-red-400/50'
                            : 'bg-green-500/30 text-green-100 border border-green-400/50'
                        ]"
                      >
                        {{ department.pending_requests_count || 0 }} pending
                      </span>
                    </div>
                    ...
                    <div class="flex space-x-2">
                      <button
                        v-if="!department.hod"
                        @click="openAssignHodDialog(department)"
                      ...
                      <button
                        v-else
                        @click="openChangeHodDialog(department)"
                        class="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 text-white py-2 px-3 rounded-lg text-xs font-semibold hover:from-orange-600 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-1"
                      >
                ...
                <div
                  v-if="!departmentsWithHodsLoading && allDepartmentsWithHods.length === 0"
      ...
      >
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-center">
          ...
          <h3 class="text-xl font-bold text-white mb-2">
            {{ isChangeMode ? 'Change' : 'Assign' }} HOD for {{ selectedDepartment?.name }}
          </h3>
          ...
          <div v-if="selectedDepartment" class="mb-6">
            <div class="bg-blue-50 rounded-xl p-4 border border-blue-100 shadow-md">
              <div class="flex items-center space-x-3 mb-3">
                ...
                <div>
                  <h4 class="font-semibold text-gray-800">{{ selectedDepartment.name }}</h4>
                  <p class="text-sm text-gray-600">Code: {{ selectedDepartment.code }}</p>
                  <p v-if="selectedDepartment.description" class="text-xs text-gray-500">
                    {{ selectedDepartment.description }}
                  </p>
                  <p
                    v-if="selectedDepartment.hod && isChangeMode"
                    class="text-sm text-blue-600 font-medium"
                  >
                    Current HOD: {{ selectedDepartment.hod.name }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                <select
                  ...
                  required
                >
                  <option value="" disabled>Choose a HOD...</option>
                  <option v-for="hod in availableHods" :key="hod.id" :value="hod.id">
              ...
              <div
                v-if="selectedHodId && selectedHodDetails"
              ...
              >
                ...
                <div class="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    <strong>Department:</strong> {{ selectedHodDetails.department?.name || 'N/A' }}
                  </div>
                  <div>
                    <strong>Roles:</strong>
                    {{ selectedHodDetails.role_display_names?.join(', ') || 'N/A' }}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="flex justify-end space-x-3 p-6 border-t border-gray-200">
          <button
            @click="closeAssignHodDialog"
            :disabled="assignHodSubmitting"
          ...
          <button
            @click="assignHod"
            :disabled="assignHodSubmitting || !selectedHodId"
          ...
          >
            <i v-if="assignHodSubmitting" class="fas fa-spinner fa-spin"></i>
            <i v-else class="fas fa-save"></i>
            <span>{{
              assignHodSubmitting ? 'Processing...' : (isChangeMode ? 'Change' : 'Assign') + ' HOD'
            }}</span>
          </button>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <div class="bg-gradient-to-r from-red-500 to-red-600 p-6 text-center">
          ...
          <h3 class="text-xl font-bold text-white mb-2">Confirm Remove HOD</h3>
          <div class="w-12 h-1 bg-white/50 mx-auto rounded-full"></div>
        </div>
        ...
        <div class="p-6 text-center">
          ...
          <div
            v-if="departmentToRemoveHod?.pending_requests_count > 0"
          ...
          >
            ...
            <p class="text-sm text-orange-700">
              This department has {{ departmentToRemoveHod.pending_requests_count }} pending
              requests. Removing the HOD will affect the approval workflow.
            </p>
          </div>

          <p class="text-xs text-gray-500 mb-6">
            The department will not have an HOD until a new one is assigned.
          </p>

          <!-- Action Buttons -->
          <div class="flex space-x-3">
            <button
              @click="removeHodDialog = false"
            ...
            >
              <i v-if="removeHodLoading" class="fas fa-spinner fa-spin"></i>
              <i v-else class="fas fa-user-minus"></i>
              <span>{{ removeHodLoading ? 'Removing...' : 'Remove HOD' }}</span>
            </button>
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <div
          class="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 p-8 text-center relative overflow-hidden rounded-t-3xl"
        >
          <!-- Background Pattern -->
          <div class="absolute inset-0 opacity-10">
            <div
              class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-white/30 to-transparent rounded-full blur-2xl"
            ></div>
            <div
              class="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-white/20 to-transparent rounded-full blur-xl"
            ></div>
          </div>
          ...
          <div class="relative z-10">
            <div
              class="w-20 h-20 bg-gradient-to-br from-white/20 to-white/10 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm border-2 border-white/30 shadow-2xl relative overflow-hidden group"
            >
              <!-- Icon Background Glow -->
              <div
                class="absolute inset-0 bg-gradient-to-br from-blue-400/30 to-blue-600/30 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              ></div>
              <!-- Multi-Layer Icon -->
              <i
                class="fas fa-building text-white text-3xl relative z-10 drop-shadow-lg group-hover:scale-110 transition-transform duration-300"
              ></i>
              <!-- Animated Particles -->
              <div
                class="absolute top-2 right-2 w-2 h-2 bg-white/60 rounded-full animate-ping"
              ></div>
              <div
                class="absolute bottom-3 left-3 w-1.5 h-1.5 bg-blue-300/80 rounded-full animate-pulse"
              ></div>
            </div>
            ...
            <h3 class="text-2xl font-bold text-white mb-3 drop-shadow-lg">
              <span class="bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent"
                >Create New Department</span
              >
            </h3>
            <p class="text-blue-100/90 text-sm mb-4 drop-shadow-sm">
              Set up a new department with advanced configuration options
            </p>
            <div
              class="w-16 h-1 bg-gradient-to-r from-white/60 to-white/30 mx-auto rounded-full shadow-sm"
            ></div>
          </div>
        </div>
        ...
        <div class="p-8 space-y-6">
          <form ref="createDepartmentForm" @submit.prevent="createDepartment">
            ...
            <div
              class="bg-gradient-to-r from-blue-50/50 to-blue-100/30 rounded-2xl p-6 border-2 border-blue-200/40 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 group"
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="group/field">
                  ...
                  <div class="relative">
                    ...
                    />
                    <div
                      class="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/5 to-blue-500/5 opacity-0 group-hover/field:opacity-100 transition-opacity duration-300 pointer-events-none"
                    ></div>
                    <div
                      class="absolute right-4 top-1/2 transform -translate-y-1/2 text-blue-400/50"
                    >
            ...
            <div
              class="bg-gradient-to-r from-green-50/50 to-emerald-100/30 rounded-2xl p-6 border-2 border-green-200/40 backdrop-blur-sm hover:shadow-lg hover:shadow-green-500/10 transition-all duration-300 group"
            >
              <div class="flex items-center space-x-3 mb-6">
                <div
                  class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-green-300/50"
                >
                  <i class="fas fa-cogs text-white text-lg"></i>
                </div>
                <h4 class="text-lg font-bold text-gray-800 flex items-center">
                  <span
                    class="bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent"
                    >Department Settings</span
                  >
                </h4>
              </div>
              ...
              <div class="mb-6">
                ...
                <div
                  class="bg-white/60 rounded-xl p-4 border border-green-200/50 hover:bg-white/80 transition-all duration-300"
                >
                  <label class="flex items-center space-x-4 cursor-pointer group/toggle">
                    <div class="relative">
                      <input v-model="newDepartment.is_active" type="checkbox" class="sr-only" />
                      <div
                        :class="[
                    ...
                    <div class="flex-1">
                      <span
                        class="text-lg font-semibold text-gray-800 group-hover/toggle:text-green-600 transition-colors duration-300"
                      >
                      ...
                      <p class="text-sm text-gray-600 mt-1">
                        {{
                          newDepartment.is_active
                            ? 'Department is active and can be assigned HODs and manage requests'
                            : 'Department is inactive and cannot manage requests'
                        }}
                      </p>
                    </div>
                    <div class="text-2xl">
            ...
            <!-- HOD Assignment Card -->
            <div
              class="bg-gradient-to-r from-purple-50/50 to-indigo-100/30 rounded-2xl p-6 border-2 border-purple-200/40 backdrop-blur-sm hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group"
            >
              <div class="flex items-center space-x-3 mb-6">
                <div
                  class="w-12 h-12 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-purple-300/50"
                >
                  <i class="fas fa-user-tie text-white text-lg"></i>
                </div>
                <h4 class="text-lg font-bold text-gray-800 flex items-center">
                  <span
                    class="bg-gradient-to-r from-purple-600 to-indigo-700 bg-clip-text text-transparent"
                    >HOD Assignment Options</span
                  >
                </h4>
              </div>
              ...
              <div
                class="bg-white/60 rounded-xl p-5 border border-purple-200/50 hover:bg-white/80 transition-all duration-300"
              >
                <label class="flex items-start space-x-4 cursor-pointer group/hod">
                  <div class="relative mt-1">
                    <input v-model="autoAssignHod" type="checkbox" class="sr-only" />
                    <div
                      :class="[
                        ...
                        autoAssignHod
                          ...
                          : 'bg-white border-gray-300 group-hover/hod:border-purple-300'
                      ]"
                    >
                  ...
                  <div class="flex-1">
                    <span
                      class="text-lg font-semibold text-gray-800 group-hover/hod:text-purple-600 transition-colors duration-300"
                    >
                      Assign HOD immediately after creation
                    </span>
                    <p class="text-sm text-gray-600 mt-2 leading-relaxed">
                      If checked, you'll be prompted to assign a Head of Department immediately
                      after the department is created. This ensures the department is ready to
                      manage requests right away.
                    </p>
                    <div class="flex items-center space-x-2 mt-3">
                      <div class="w-2 h-2 bg-purple-400 rounded-full animate-pulse"></div>
                      <span class="text-xs text-purple-600 font-medium"
                        >Recommended for immediate deployment</span
                      >
                    </div>
                  </div>
                  <div class="text-2xl mt-1">
                    <i
                      :class="[
                        'fas transition-all duration-300',
                        autoAssignHod
                          ? 'fa-user-check text-purple-500'
                          : 'fa-user-clock text-gray-400'
                      ]"
                    ></i>
                  </div>
                </label>
        ...
        <div
          class="flex justify-between items-center p-8 border-t-2 border-blue-100/50 bg-gradient-to-r from-gray-50/50 to-blue-50/30 rounded-b-3xl"
        >
          ...
          <div class="flex space-x-4">
            ...
            >
              <!-- Button Shine Effect -->
              <div
                class="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -skew-x-12 -translate-x-full group-hover/create:translate-x-full transition-transform duration-700"
              ></div>
              ...
              <div class="relative z-10 flex items-center space-x-3">
                ...
                <span class="font-bold">{{
                  createDepartmentSubmitting ? 'Creating Department...' : 'Create Department'
                }}</span>
                <i
                  class="fas fa-arrow-right group-hover/create:translate-x-1 transition-transform duration-300"
                ></i>
              </div>
            </button>
          </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: 'Current HOD', value: 'hod', sortable: false, width: '300px' },
          {
        ...
        hodStatusOptions: [
          { text: 'All Departments', value: null },
          { text: 'With HOD', value: 'assigned' },
          { text: 'Without HOD', value: 'unassigned' }
        ],
        ...
        removeHodDialog: false,
        createDepartmentDialog: false,

        // Form data
        selectedHodId: null,
        assignHodFormValid: false,
        assignHodSubmitting: false,
        assignHodFormErrors: {},
        isChangeMode: false,

        // Validation rules
        hodSelectionRules: [(v) => !!v || 'HOD selection is required'],
      ...
      departmentStatistics() {
        return {
          ...
          with_pending_requests:
            this.departmentStatisticsData.departments_with_pending_requests || 0
        }
      },
    ...
    watch: {
      ...
      assignHodDialog(val) {
        if (!val) {
          this.resetAssignHodForm()
        }
      },

      createDepartmentDialog(val) {
        if (!val) {
          this.resetCreateDepartmentForm()
        }
      }
    },
    ...
    methods: {
      ...
      async initializeData() {
        try {
          await Promise.all([
            this.fetchDepartmentsWithHods(this.getFilterParams()),
            this.fetchEligibleHods(),
            this.fetchDepartmentHodStatistics()
          ])
        } catch (error) {
      ...
      async applyFilters() {
        ...
        await this.fetchDepartmentsWithHods(this.getFilterParams())
      },
      ...
      getFilterParams() {
        return {
          ...
          hod_status: this.hodStatus,
          is_active: this.showActiveOnly,
          sort_by: this.sortBy,
      ...
      // HOD assignment methods
      openAssignHodDialog(department) {
        this.setSelectedDepartment(department)
        this.isChangeMode = false
        this.assignHodDialog = true
      },

      openChangeHodDialog(department) {
        this.setSelectedDepartment(department)
        this.selectedHodId = department.hod?.id || null
        this.isChangeMode = true
        this.assignHodDialog = true
      },

      closeAssignHodDialog() {
      ...
      resetAssignHodForm() {
        ...
        this.assignHodFormErrors = {}
        this.assignHodFormValid = false
        this.isChangeMode = false

        if (this.$refs.assignHodForm) {
          this.$refs.assignHodForm.resetValidation()
        }
      },

      async assignHod() {
        if (!this.$refs.assignHodForm.validate()) {
          return
        }

        this.assignHodSubmitting = true
        this.assignHodFormErrors = {}

        try {
          const result = await this.assignHodToDepartment({
            departmentId: this.selectedDepartment.id,
            hodUserId: this.selectedHodId
          })

          if (result.success) {
            this.closeAssignHodDialog()
            await Promise.all([this.fetchEligibleHods(), this.fetchDepartmentHodStatistics()])
          } else {
            this.assignHodFormErrors = result.errors || {}
          }
        } catch (error) {
          console.error('Error assigning HOD:', error)
        } finally {
          this.assignHodSubmitting = false
        }
      },

      // Remove HOD methods
      confirmRemoveHod(department) {
        this.departmentToRemoveHod = department
        this.removeHodDialog = true
      },

      async removeHod() {
        if (!this.departmentToRemoveHod) return

        this.removeHodLoading = true

        try {
          const result = await this.removeHodFromDepartment(this.departmentToRemoveHod.id)

          if (result.success) {
            this.removeHodDialog = false
            this.departmentToRemoveHod = null
            await Promise.all([this.fetchEligibleHods(), this.fetchDepartmentHodStatistics()])
          }
        } catch (error) {
          console.error('Error removing HOD:', error)
        } finally {
          this.removeHodLoading = false
        }
      },
      ...
      resetCreateDepartmentForm() {
        ...
        this.createDepartmentFormErrors = {}
        this.autoAssignHod = false
        this.createDepartmentSubmitting = false
      },
      ...
      async createDepartment() {
        ...
        this.createDepartmentSubmitting = true
        this.createDepartmentFormErrors = {}

        try {
          const result = await this.createDepartmentAPI(this.newDepartment)
          ...
          if (result.success) {
            ...
            if (this.autoAssignHod) {
              ...
              // Simulate the new department for HOD assignment
              const newDepartment = {
                id: result.data.id,
              ...
              this.openAssignHodDialog(newDepartment)
            } else {
              this.closeCreateDepartmentDialog()
            }
            ...
            this.createDepartmentFormErrors = result.errors || {}
            this.showErrorMessage('Failed to create department. Please check the form for errors.')
          }
        } catch (error) {
          console.error('Error creating department:', error)
          this.showErrorMessage('An error occurred while creating the department')
        } finally {
          this.createDepartmentSubmitting = false
        }
      },
      ...
      getFieldError(fieldName) {
        // Check assign HOD form errors first
        if (this.assignHodFormErrors[fieldName]) {
          return this.assignHodFormErrors[fieldName][0]
        }
        // Check create department form errors
        if (this.createDepartmentFormErrors[fieldName]) {
          return this.createDepartmentFormErrors[fieldName][0]
        }
        return ''
      },
