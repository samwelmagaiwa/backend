          ...
          <div class="medical-glass-card rounded-b-3xl overflow-hidden">
            <div class="p-6 space-y-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div
                  class="medical-card bg-gradient-to-r from-blue-600/25 to-blue-600/25 border-2 border-blue-400/40 p-6 rounded-2xl backdrop-blur-sm"
                >
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      >
                        ...
                        <option value="without_hod" class="bg-gray-800 text-white">
                          Without HOD
                        </option>
                      </select>
                      <div
      ...
      >
        ...
        <div class="p-6">
          <form @submit.prevent="submitForm">
            ...
            <div
              class="medical-card bg-gradient-to-r from-blue-600/15 to-cyan-600/15 border-2 border-blue-400/30 p-6 rounded-2xl backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 mb-6"
            >
            ...
            <div
              class="medical-card bg-gradient-to-r from-blue-600/15 to-blue-600/15 border-2 border-blue-400/30 p-6 rounded-2xl backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 mb-6"
            >
              <div class="flex items-center space-x-3 mb-6">
                <div
                  class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg"
  ...
  export default {
    ...
    setup() {
      ...
      const initializeData = async () => {
        loading.value = true
        try {
          await Promise.all([fetchDepartments(), fetchFormData()])
          calculateStatistics()
        } catch (error) {
      ...
      const fetchFormData = async (departmentId = null) => {
        try {
          console.log(
            'Fetching form data...',
            departmentId ? `for department ${departmentId}` : 'for new department'
          )
          ...
          if (response.success) {
            ...
            console.log(
              'Form data loaded - HODs:',
              eligibleHods.value.length,
              'Directors:',
              eligibleDivisionalDirectors.value.length
            )
