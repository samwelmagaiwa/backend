    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div><strong>User Roles:</strong> {{ JSON.stringify(userRoles) }}</div>
        ...
        <div class="mt-4">
          ...
          <pre class="bg-gray-100 p-3 rounded mt-2 text-sm overflow-auto">{{
      ...
      <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div><strong>Requests Count:</strong> {{ requests.length }}</div>
          <div><strong>Is Component Loading:</strong> {{ isComponentLoading }}</div>
          <div><strong>Component Error:</strong> {{ componentError }}</div>
          <div><strong>Last Refresh:</strong> {{ lastRefreshTime }}</div>
        </div>
