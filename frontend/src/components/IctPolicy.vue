  ...
  >
    ...
    <div class="max-w-8xl mx-auto relative z-10">
      ...
      >
        <div class="text-center">
          ...
          <p class="text-blue-100 text-lg font-medium">
            Muhimbili National Hospital - Information and Communication
            ...
            <div class="ml-16">
              <p class="text-blue-100 leading-relaxed mb-4">
                ...
                <strong class="text-emerald-300"
                  >secure, efficient, and appropriate use</strong
                >
                of information and communication technology resources at
              ...
              >
                <p class="text-sm text-blue-100">
                  <strong class="text-emerald-300">Scope:</strong> This policy
                  applies to all staff, contractors, volunteers, and authorized
                  users of hospital ICT systems, networks, and devices.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="ml-16">
              <p class="text-blue-100 leading-relaxed mb-4">
                ...
                <strong class="text-emerald-300">paramount</strong> to
                protecting patient data, hospital operations, and institutional
                reputation.
              </p>
          ...
          >
            ...
            <div class="ml-16">
              <p class="text-blue-100 leading-relaxed mb-4">
                ...
                <strong class="text-emerald-300"
                  >legitimate business purposes</strong
                >
                only.
              </p>
              ...
              >
                ...
                <div class="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4
                      class="font-semibold text-emerald-300 mb-2 flex items-center"
                    >
            ...
            <div class="ml-16">
              ...
              >
                ...
                <p class="text-blue-100 mb-4">
                  ...
                  <strong class="text-emerald-300">mandatory</strong>.
          ...
          >
            ...
            <div class="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p class="text-sm text-blue-100">
                  Phone: +255 22 215 0302 (Ext. 2150)
                </p>
              ...
              >
                ...
                <p class="text-sm text-blue-100">
                  Phone: +255 22 215 0302 (Ext. 2100)
                </p>
                <p class="text-sm text-blue-100">
                  Office: ICT Building, 2nd Floor
                </p>
                <p class="text-sm text-blue-100">
                  <strong class="text-emerald-300">Office Hours:</strong> Monday
            ...
            <div class="grid md:grid-cols-2 gap-8 ml-16">
              ...
              <div>
                <p class="text-blue-100 mb-6 leading-relaxed">
                  By using hospital ICT systems, you confirm that you understand
                  and agree to comply with this ICT Policy and all related
                  procedures.
                </p>
                  ...
                  <label class="flex items-start cursor-pointer">
                    <span class="text-blue-100 leading-relaxed">
                      <strong class="text-white"
                        >I have read and accept the ICT Policy</strong
                      ><br />
                      <span class="text-blue-200 text-sm">
                        I agree to comply with all policy requirements and
                        understand that violations may result in disciplinary
              ...
              <div class="flex flex-col justify-center">
                ...
                >
                  ...
                  <p class="text-emerald-100 text-sm mb-4">
                    You have completed the required reading time. Select the
                    checkbox to proceed.
                  </p>
      ...
      <div class="text-center mt-8">
        ...
        >
          <p class="text-sm text-blue-100">
            © 2025 Muhimbili National Hospital - ICT Department | Policy
