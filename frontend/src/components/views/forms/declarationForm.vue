  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-teal-900 py-8 px-4 relative overflow-hidden">
    ...
    <div class="max-w-8xl mx-auto relative z-10">
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="text-center flex-1">
            ...
            <div class="relative inline-block mb-4">
              <div class="bg-gradient-to-r from-red-600 to-red-700 text-white px-10 py-4 rounded-full text-xl font-bold shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-red-400/60">
                <span class="relative z-10 flex items-center gap-2">
                  <i class="fas fa-shield-alt"></i>
                  RESTRICTED
                </span>
                <div class="absolute inset-0 bg-gradient-to-r from-red-700 to-red-800 rounded-full opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
              </div>
            </div>
      ...
      <div class="medical-glass-card rounded-b-3xl overflow-hidden">
        <form @submit.prevent="submitDeclaration" class="p-8 space-y-8">
          ...
          <div class="medical-card bg-gradient-to-r from-blue-600/25 to-cyan-600/25 border-2 border-blue-400/40 p-8 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 group">
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <div class="text-blue-100 leading-relaxed space-y-4">
                  <p class="text-base font-medium">
                    These declarations have been designed to certify that users acknowledge that they are 
                    aware of Muhimbili National Hospital Acceptable Information and Communication 
                    Technology use policy and agree to abide by their terms.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div class="relative">
                  <select 
                    ...
                    class="medical-input w-full px-4 py-4 bg-white/15 border-2 border-blue-300/30 rounded-xl focus:border-teal-400 focus:outline-none text-white backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-teal-500/20 appearance-none cursor-pointer"
                    required
                  >
                    <option value="" disabled class="bg-gray-800 text-gray-300">Select your department</option>
                    <option 
          ...
          <div class="medical-card bg-gradient-to-r from-cyan-600/25 to-blue-600/25 border-2 border-cyan-400/40 p-6 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 group">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-10 h-10 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-cyan-300/50">
                <i class="fas fa-file-contract text-white text-sm"></i>
              </div>
              <h3 class="text-lg font-bold text-white flex items-center">
                <i class="fas fa-scroll mr-2 text-cyan-300 text-sm"></i>
                Declaration Statement
              </h3>
            </div>
            
            <div class="bg-white/15 p-6 rounded-xl backdrop-blur-sm border-2 border-cyan-300/30">
              <div class="text-blue-100 leading-relaxed text-lg space-y-5 text-justify">
                <p>
                  I <strong class="text-cyan-300">{{ formData.fullName || '______________________' }}</strong> 
                  PF No. <strong class="text-cyan-300">{{ formData.pfNumber || '______' }}</strong> 
                ...
                <p>
                  I certify that I have been given ample opportunity to read and understand it, and ask 
                  questions about my responsibilities on it. I am, therefore, aware that I am accountable 
                  to all its terms and requirements; and that I shall abide by them.
                </p>
                
                <p>
                  I also understand that failure to abide by them; Muhimbili National Hospital shall take 
                  against me appropriate disciplinary action or legal action, or both, as the case may be.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="medical-card bg-gradient-to-r from-emerald-600/25 to-teal-600/25 border-2 border-emerald-400/40 p-6 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 group">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-emerald-300/50">
                <i class="fas fa-signature text-white text-sm"></i>
              </div>
              <h3 class="text-lg font-bold text-white flex items-center">
                <i class="fas fa-pen-fancy mr-2 text-emerald-300 text-sm"></i>
                Digital Signature
              </h3>
            </div>
              ...
              <div class="md:col-span-2">
                ...
                <div class="relative">
                  <div 
                    ...
                    class="w-full px-3 py-3 border-2 border-dashed border-emerald-300/40 rounded-lg focus-within:border-emerald-400 bg-white/15 backdrop-blur-sm transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-emerald-500/20 min-h-[60px] flex items-center justify-center hover:bg-white/20"
                  >
                    <div class="text-center">
                      ...
                      <button 
                        type="button" 
                        @click="loadSignature"
                        class="px-3 py-1 bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-xs font-semibold rounded-md hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 flex items-center gap-1 mx-auto shadow-lg hover:shadow-xl transform hover:scale-105 border border-emerald-400/50"
                      >
                  ...
                  <div 
                    v-else 
                    class="w-full px-3 py-2 border-2 border-emerald-300/40 rounded-lg bg-white/15 backdrop-blur-sm transition-all duration-300 shadow-sm hover:shadow-md min-h-[50px] flex items-center justify-center relative"
                  >
                    <div v-if="isImage(signaturePreview)" class="text-center">
                      ...
                      />
                      <p class="text-xs text-blue-100 truncate">{{ signatureFileName }}</p>
                    </div>
                    <div v-else class="text-center">
                      <div class="w-6 h-6 bg-red-500/20 rounded-lg flex items-center justify-center mx-auto mb-1">
              ...
              <div>
                ...
                <div class="relative">
                  <input 
                    ...
                    type="date" 
                    class="medical-input w-full px-3 py-3 bg-white/15 border-2 border-emerald-300/30 rounded-xl focus:border-emerald-400 focus:outline-none text-white backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-emerald-500/20"
                    required
                  />
                  <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-emerald-500/10 to-teal-500/10 opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Agreement Checkbox -->
          <div class="medical-card bg-gradient-to-r from-red-600/25 to-rose-600/25 border-2 border-red-400/40 p-8 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-red-500/20 transition-all duration-500 group">
            <div class="flex items-start space-x-4">
              <div class="flex-shrink-0 mt-1">
                <div class="relative">
                  <input 
                    ...
                    required
                  />
                  <div class="absolute inset-0 rounded-lg bg-gradient-to-r from-red-500/10 to-rose-500/10 opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                </div>
              </div>
              <label for="agreement" class="text-sm text-blue-100 leading-relaxed flex-1">
                <span class="font-bold text-red-300 flex items-center gap-2"><i class="fas fa-exclamation-triangle"></i>I hereby confirm that:</span> I have read, understood, and agree to abide by all terms and conditions of the Muhimbili National Hospital Acceptable ICT Use Policy. I acknowledge that violation of this policy may result in disciplinary action or legal consequences.
              </label>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async submitDeclaration() {
      if (!this.isFormValid) {
        this.showNotification('Please fill in all required fields and agree to the terms', 'error')
        return
      }
