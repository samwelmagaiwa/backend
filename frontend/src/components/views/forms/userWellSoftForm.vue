    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <main class="flex-1 p-6 bg-gradient-to-br from-blue-900 via-blue-800 to-teal-900 overflow-y-auto relative">
        ...
        <form @submit.prevent="submitForm" class="p-8 space-y-8">
          ...
          <div class="medical-card bg-gradient-to-r from-blue-600/25 to-purple-600/25 border-2 border-blue-400/40 p-8 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 group">
            <div class="flex items-center space-x-4 mb-6">
              <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-blue-300/50">
            ...
            <div class="space-y-6">
                ...
                <div class="group">
                  ...
                  <div class="relative">
                    <input 
                      ...
                      type="text" 
                      class="medical-input w-full px-4 py-4 bg-white/15 border-2 rounded-xl focus:outline-none text-white placeholder-blue-200/60 backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-blue-500/20 group-hover:border-blue-400/50"
                      :class="{
                      ...
                      required
                    />
                    <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                ...
                <div class="group">
                  ...
                  <div class="relative">
                    <select 
                      ...
                      class="w-full px-4 py-4 border-2 rounded-xl focus:outline-none text-white bg-blue-100/20 focus:bg-blue-100/30 transition-all backdrop-blur-sm group-hover:border-blue-400/50 appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                      :class="{
                  ...
                  <!-- Department loading error with retry -->
                  <div v-if="departments.length === 0 && !isLoadingDepartments" class="text-yellow-400 text-xs mt-1 flex items-center justify-between animate-fade-in">
              ...
              <div class="bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-6 rounded-2xl border border-blue-300/20 backdrop-blur-sm">
                <div class="group">
          ...
          <div class="flex justify-between items-center pt-6 border-t border-gray-200">
            <button
              type="button"
              @click="goBack"
              class="px-6 py-3 bg-gray-500 text-white rounded-lg font-medium hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition duration-200 flex items-center"
            >
            ...
            <button
              ...
              class="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-medium hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
            >
                  ...
                  <div class="relative px-8 py-8">
                    ...
                    <div class="text-center mb-8">
                      ...
                      <p class="text-lg text-blue-900 font-semibold mb-3 leading-relaxed">
                        Your WellSoft access request has been submitted and is now under review.
                      </p>
...
import { userWellsoftFormService } from '@/services/userWellsoftFormService.js'
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      console.log('🚀 Starting Wellsoft form submission...')
      
      // Client-side validation
      const validation = userWellsoftFormService.validateFormData(this.formData)
      ...
      try {
        ...
        const formData = userWellsoftFormService.createFormData(this.formData)
        
        // Submit to backend
        const response = await userWellsoftFormService.submitRequest(formData)
        
        if (response.success) {
          console.log('✅ Wellsoft form submitted successfully:', response)
        ...
        console.error('❌ Error submitting Wellsoft form:', error)
    ...
    async loadDepartments() {
      ...
      try {
        ...
        const response = await userWellsoftFormService.getDepartments()
