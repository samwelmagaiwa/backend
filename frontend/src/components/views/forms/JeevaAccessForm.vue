  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <div class="medical-glass-card rounded-b-3xl overflow-hidden">
        <form @submit.prevent="submitForm" :class="['p-6 space-y-4', { 'review-mode': isReviewMode }]">
          
          <!-- Personal Information Section -->
          <div class="medical-card bg-gradient-to-r from-blue-600/25 to-blue-700/25 border-2 border-blue-400/40 p-3 rounded-xl backdrop-blur-sm hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-500 group">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-10 h-10 bg-gradient-to-br from-teal-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-teal-300/50">
              ...
              <div class="md:col-span-2">
                ...
                <div class="relative">
                  ...
                  <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                    <i v-if="departmentsLoading" class="fas fa-spinner fa-spin text-blue-300"></i>
                    <i v-else class="fas fa-chevron-down text-blue-300"></i>
                  </div>
                  <div class="absolute inset-0 rounded-lg bg-gradient-to-r from-teal-500/10 to-blue-500/10 opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                </div>
                <!-- Error message for departments -->
                <div v-if="departmentsError" class="mt-2 text-red-400 text-sm flex items-center">
                ...
                <div class="relative">
                  ...
                  >
                    <div v-if="isImage(signaturePreview)" class="text-center">
                      ...
                      />
                      <p class="text-xs text-blue-100">{{ signatureFileName }}</p>
                    </div>
                    <div v-else class="text-center">
                      <div class="w-10 h-10 bg-red-500/20 rounded-lg flex items-center justify-center mx-auto mb-1">
          ...
          <div class="medical-card bg-gradient-to-r from-blue-600/25 to-blue-700/25 border-2 border-blue-400/40 p-4 rounded-xl backdrop-blur-sm hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-500 group">
            ...
            <div class="mb-4">
              ...
              <div class="flex justify-center gap-4 mb-3">
                <label class="flex items-center cursor-pointer p-3 border-2 border-blue-300/30 rounded-lg hover:border-blue-400 hover:bg-white/10 transition-all backdrop-blur-sm">
                  <input 
            ...
            <div>
              ...
              <div class="bg-white/15 rounded-lg p-3 max-h-80 border-2 border-blue-300/30 backdrop-blur-sm overflow-y-auto">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1">
                  <label v-for="module in modules" :key="module.id" class="flex items-center p-1.5 hover:bg-white/20 rounded-md cursor-pointer transition-all duration-300 border border-blue-300/20 hover:border-blue-400/40">
                    <input 
          ...
          <div class="medical-card bg-gradient-to-r from-blue-600/25 to-blue-700/25 border-2 border-blue-400/40 p-4 rounded-xl backdrop-blur-sm hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-500 group">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <!-- HoD/BM -->
              <div class="bg-white/15 rounded-xl p-4 border border-emerald-300/30 backdrop-blur-sm">
                ...
                <div class="space-y-3">
                  ...
                  <div class="relative">
                    ...
                    >
                      ...
                      <div v-else class="text-center">
                        <div class="w-8 h-8 bg-red-500/20 rounded flex items-center justify-center mx-auto mb-1">
                  ...
                  <input 
                    v-model="formData.approvals.hod.date" type="date" 
              ...
              <!-- Divisional Director -->
              <div class="bg-white/15 rounded-xl p-4 border border-emerald-300/30 backdrop-blur-sm">
                <h5 class="font-bold text-white mb-3 text-center text-sm">Divisional Director</h5>
                <div class="space-y-3">
                  <!-- Decision Section for Divisional Director -->
                  <div v-if="userRole === ROLES.DIVISIONAL_DIRECTOR && canApproveAtStage()" class="mb-4">
                    <label class="block text-sm font-bold text-blue-100 mb-2">
                      Decision <span class="text-red-400">*</span>
                    </label>
                    <div class="flex gap-3 mb-3">
                      <label class="flex items-center cursor-pointer p-3 border-2 border-blue-300/30 rounded-lg hover:border-emerald-400 hover:bg-white/10 transition-all backdrop-blur-sm">
                        <input 
                      ...
                      <label class="flex items-center cursor-pointer p-3 border-2 border-blue-300/30 rounded-lg hover:border-red-400 hover:bg-white/10 transition-all backdrop-blur-sm">
                        <input 
                          v-model="formData.approvals.divisionalDirector.decision" 
                          type="radio" 
                          value="reject" 
                    ...
                    <div v-if="formData.approvals.divisionalDirector.decision === 'reject'" class="mb-3">
                      <label class="block text-sm font-bold text-blue-100 mb-2">
                  ...
                  <input 
                    v-model="formData.approvals.divisionalDirector.date" type="date" 
              ...
              <div class="bg-white/15 rounded-xl p-4 border border-emerald-300/30 backdrop-blur-sm">
                ...
                <div class="space-y-3">
                  ...
                  <input 
                    v-model="formData.approvals.directorICT.date" type="date" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="bg-white/15 rounded-xl p-4 border border-purple-300/30 backdrop-blur-sm">
                ...
                <div class="space-y-3">
                    ...
                    >
                      <div v-if="isImage(headITSignaturePreview)" class="text-center">
                        <img 
                          ...
                          class="max-h-[35px] max-w-full object-contain mx-auto mb-1"
                        />
                        <p class="text-xs text-blue-100">{{ headITSignatureFileName }}</p>
                      </div>
                      <div v-else class="text-center">
                        <div class="w-8 h-8 bg-red-500/20 rounded flex items-center justify-center mx-auto mb-1">
                          <i class="fas fa-file-pdf text-red-400 text-sm"></i>
                  ...
                  <input 
                    v-model="formData.implementation.headIT.Date" type="date" 
              ...
              <!-- ICT Officer -->
              <div class="bg-white/15 rounded-xl p-4 border border-purple-300/30 backdrop-blur-sm">
                <h5 class="font-bold text-white mb-3 text-center text-sm">ICT Officer granting access</h5>
                <div class="space-y-3">
                  <input 
                  ...
                  <input 
                    v-model="formData.implementation.ictOfficer.Date" type="date" 
                    class="w-full px-3 py-2 border border-purple-300/30 rounded-lg focus:border-purple-400 focus:outline-none text-sm bg-white/15 text-white backdrop-blur-sm"
                  />
                </div>
              </div>
  ...
  methods: {
    submitForm() {
      ...
      if (!this.formData.pfNumber || !this.formData.staffName || !this.formData.department_id) {
        this.showNotification('Please fill in all required fields (PF Number, Staff Name, and Department)')
        return
      }
      ...
      if (this.formData.accessType === 'temporary') {
        if (!this.formData.tempDate.day || !this.formData.tempDate.month || !this.formData.tempDate.year) {
    ...
    populateFormFromQuery() {
      ...
      this.formData.accessType = query.accessType === 'Permanent (until retirement)' ? 'permanent' : 'temporary'
    ...
    canHodEdit(element) {
      ...
      if (this.userRole === this.ROLES.DIVISIONAL_DIRECTOR && this.canApproveAtStage()) {
        ...
        if (divDirectorEditableClasses.some(className => element.classList.contains(className))) {
          return true
        }
      }
    ...
    approveRequest() {
      ...
      if (this.userRole === this.ROLES.DIVISIONAL_DIRECTOR) {
        ...
        if (this.formData.approvals.divisionalDirector.decision === 'reject') {
          ...
          if (confirm(`Are you sure you want to reject request ${this.requestId}? This will send it back to the Head of Department.`)) {
    ...
    rejectRequest() {
      ...
      if (this.userRole === this.ROLES.DIVISIONAL_DIRECTOR) {
        ...
        this.showNotification('Please provide a reason for rejection in the comments field below.')
        return
      }
