        ...
        <div class="max-w-12xl mx-auto relative z-10">
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="text-center flex-1">
                ...
                <div class="relative inline-block mb-2">
                  <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2 rounded-full text-lg font-bold shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-blue-400/60">
          ...
          <div class="medical-glass-card rounded-b-3xl overflow-hidden">
            <form @submit.prevent="submitForm" class="p-8 space-y-6">
              ...
              <div class="medical-card bg-gradient-to-r from-blue-600/25 to-blue-700/25 border-2 border-blue-400/40 p-4 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 group">
                ...
                <div class="space-y-4">
                    ...
                    <div class="group">
                      ...
                      <div class="relative">
                        <input 
                          ...
                          type="text" 
                          class="medical-input w-full px-3 py-3 bg-white/15 border-2 rounded-xl focus:outline-none text-white placeholder-blue-200/60 backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-blue-500/20 group-hover:border-blue-400/50"
                          :class="{
                            'border-blue-300/30 focus:border-blue-400': !errors.pfNumber && !validationState.pfNumber.isValid,
                        ...
                        <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-300/50">
                          <i v-if="checkingSignature" class="fas fa-spinner fa-spin"></i>
                          <i v-else-if="signatureExists" class="fas fa-check-circle text-green-400"></i>
                          <i v-else-if="validationState.pfNumber.isValid && formData.pfNumber" class="fas fa-check text-green-400"></i>
                    ...
                    <div class="group">
                      ...
                      <div class="relative">
                        <input 
                          ...
                          class="medical-input w-full px-3 py-3 bg-white/15 border-2 rounded-xl focus:outline-none text-white placeholder-blue-200/60 backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-blue-500/20 group-hover:border-blue-400/50"
                          :class="{
                            'border-blue-300/30 focus:border-blue-400': !errors.staffName && !validationState.staffName.isValid,
                    ...
                    <div class="group">
                      ...
                      <div class="relative">
                        <input 
                          ...
                          class="medical-input w-full px-3 py-3 bg-white/15 border-2 rounded-xl focus:outline-none text-white placeholder-blue-200/60 backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-blue-500/20 group-hover:border-blue-400/50"
                          :class="{
                            'border-blue-300/30 focus:border-blue-400': !errors.phoneNumber && !validationState.phoneNumber.isValid,
                    ...
                    <div class="group">
                      ...
                      <div class="relative">
                        <select 
                          ...
                          class="w-full px-3 py-3 border-2 rounded-xl focus:outline-none text-white bg-blue-100/20 focus:bg-blue-100/30 transition-all backdrop-blur-sm group-hover:border-blue-400/50 appearance-none cursor-pointer"
                          :class="{
                            'border-blue-300/30 focus:border-blue-400': !errors.department && !validationState.department.isValid,
                        ...
                        >
                          ...
                          <option v-for="dept in departments" :key="dept.id" :value="dept.id" class="bg-blue-800 text-white">
                            {{ dept.name }} {{ dept.code ? `(${dept.code})` : '' }}
                          </option>
                        </select>
                        <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-300/50 pointer-events-none">
                          <i v-if="departmentsLoading" class="fas fa-spinner fa-spin"></i>
                          <i v-else-if="validationState.department.isValid && formData.department" class="fas fa-check text-green-400"></i>
                      ...
                      <div v-if="departmentsError" class="text-red-400 text-xs mt-1 flex items-center">
                  ...
                  <div class="bg-gradient-to-r from-blue-500/10 to-blue-600/10 p-4 rounded-2xl border border-blue-300/20 backdrop-blur-sm">
                    <div class="group">
                      ...
                      <div class="flex flex-col md:flex-row gap-4 items-start">
                        ...
                        <div class="relative w-full md:w-80 h-20 border-2 border-blue-300/30 rounded-xl bg-blue-100/20 focus-within:bg-blue-100/30 focus-within:border-blue-400 overflow-hidden backdrop-blur-sm group-hover:border-blue-400/50 transition-all duration-300">
                          ...
                          <div v-if="signaturePreview" class="w-full h-full flex items-center justify-center p-2">
                            ...
                            />
                            <!-- Existing signature indicator -->
                            <div v-if="signatureExists" class="absolute top-1 left-1 bg-green-500 text-white text-xs px-2 py-1 rounded">
                          ...
                          <div v-else class="w-full h-full flex items-center justify-center">
                            <div class="text-center">
                              <i class="fas fa-signature text-blue-400/50 text-2xl mb-1"></i>
                        ...
                        <div class="flex flex-col gap-2">
                          ...
                          <button
                            ...
                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-medium rounded-xl hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105 border border-blue-400/30"
                          >
                            <span v-if="signatureExists" class="flex items-center">
                              <i class="fas fa-check mr-2"></i>
                              Using Existing Signature
                            </span>
                            <span v-else-if="uploadProgress === 0" class="flex items-center">
              ...
              <div class="border-t-3 border-gray-200 pt-1">
                ...
                <div class="flex justify-between items-center">
                  <button type="button" @click="goBack"
                    class="px-3 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-all duration-300 font-semibold flex items-center shadow-lg hover:shadow-xl"
                  >
                ...
                <div class="relative px-8 py-8">
                  ...
                  <div class="text-center mb-8">
                    ...
                    <p class="text-lg text-blue-900 font-semibold mb-3 leading-relaxed">
                      Your Jeeva access request has been submitted and is now under review.
                    </p>
...
import { userJeevaFormService } from '@/services/userJeevaFormService.js'
...
export default {
  ...
  methods: {
    ...
    validatePfNumber() {
      ...
      // Trigger signature check and other PF number logic
      this.onPfNumberChange()
    },
    ...
    validateDepartment() {
      ...
      const departmentExists = this.departments.some(dept => dept.id == department)
      if (!departmentExists) {
        this.validationState.department = {
          isValid: false,
    ...
    // PF Number change handler
    onPfNumberChange() {
      // Clear previous signature when PF number changes
      if (!this.signatureExists) {
        this.removeFile()
      }
      
      // Check for existing signature after a short delay
      clearTimeout(this.pfNumberTimeout)
      this.pfNumberTimeout = setTimeout(() => {
    ...
    async submitForm() {
      ...
      const validation = userJeevaFormService.validateFormData(this.formData)
      ...
      try {
        ...
        const formData = userJeevaFormService.createFormData(this.formData)
        
        // Submit to backend
        const response = await userJeevaFormService.submitRequest(formData)
        ...
        if (error.details) {
          ...
          if (error.details.pf_number) {
            console.error('🆔 PF Number validation error:', error.details.pf_number)
            
            // Show helpful message for PF number mismatch
            if (error.details.pf_number.includes('does not match')) {
              this.errors.general = 'PF Number issue: ' + error.details.pf_number + ' Please check your profile or contact support.'
            }
          }
    ...
    async loadDepartments() {
      ...
      try {
        const response = await userJeevaFormService.getDepartments()
        ...
        this.departmentsError = error.message || 'Failed to load departments'
        
        // Fallback to static departments list
        this.departments = [
          { id: 1, name: 'Administration' },
          { id: 2, name: 'ICT Department' },
          { id: 3, name: 'Finance' },
          { id: 4, name: 'Human Resources' },
          { id: 5, name: 'Medical Services' }
        ]
      } finally {
    ...
    async checkExistingSignature() {
      if (!this.formData.pfNumber?.trim()) {
        return
      }
      ...
      try {
        const response = await userJeevaFormService.checkSignature(this.formData.pfNumber)
        
        if (response.success && response.data.signature_exists) {
          this.signatureExists = true
          this.signaturePreview = response.data.signature_url
          this.signatureFileName = 'Existing signature'
          this.formData.signature = 'existing' // Mark as existing
          this.errors.signature = '' // Clear any signature errors
        } else {
