<template>
  <div class="flex flex-col h-screen">
        ...
        <div class="max-w-full mx-auto px-4 relative z-10">
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="w-28 h-28 mr-8 transform hover:scale-110 transition-transform duration-300">
                <div class="w-full h-full bg-gradient-to-br from-blue-500/20 to-teal-500/20 rounded-2xl backdrop-blur-sm border-2 border-blue-300/40 flex items-center justify-center shadow-2xl hover:shadow-blue-500/25">
                  <img src="/assets/images/ngao2.png" alt="National Shield" class="max-w-20 max-h-20 object-contain" />
                </div>
              </div>
              ...
              <div class="w-28 h-28 ml-8 transform hover:scale-110 transition-transform duration-300">
                <div class="w-full h-full bg-gradient-to-br from-teal-500/20 to-blue-500/20 rounded-2xl backdrop-blur-sm border-2 border-teal-300/40 flex items-center justify-center shadow-2xl hover:shadow-teal-500/25">
                  <img src="/assets/images/logo2.png" alt="Muhimbili Logo" class="max-w-20 max-h-20 object-contain" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="booking-glass-card rounded-b-3xl overflow-hidden animate-slide-up">
            <div class="p-8 space-y-8">
              ...
              <div class="booking-card bg-gradient-to-r from-teal-600/25 to-blue-600/25 border-2 border-teal-400/40 p-6 rounded-2xl backdrop-blur-sm hover:shadow-xl hover:shadow-teal-500/20 transition-all duration-500 group">
                <div class="flex items-center space-x-4 mb-6">
                  <div class="w-12 h-12 bg-gradient-to-br from-teal-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-teal-300/50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div class="group">
                    ...
                    <div class="px-4 py-3 bg-white/10 border border-blue-300/30 rounded-lg text-white text-sm backdrop-blur-sm">
                  ...
                  <div class="group">
                    ...
                    <div class="px-4 py-3 bg-white/10 border border-blue-300/30 rounded-lg text-white text-sm backdrop-blur-sm">
                      {{ formatDate(request.collectionDate) }} at {{ request.returnTime }}
                    </div>
                  </div>

                  <!-- Signature Status -->
                  <div class="group">
                    <label class="block text-sm font-semibold text-blue-100 mb-2 flex items-center justify-center">
                      <i class="fas fa-signature mr-2 text-teal-300 text-sm"></i>
                      Signature Status
                    </label>
                    <div class="px-4 py-3 bg-white/10 border border-blue-300/30 rounded-lg text-white text-sm backdrop-blur-sm">
                      <div v-if="request.signature" class="flex items-center justify-center text-green-400">
                ...
                <div v-if="request.signature" class="mt-6">
                  ...
                  <div class="px-4 py-3 bg-white/10 border border-blue-300/30 rounded-lg backdrop-blur-sm">
                    <div class="flex flex-col items-center space-y-3">
                      <div class="inline-block bg-white/20 p-3 rounded-lg border border-teal-300/30">
                        <img :src="request.signature" alt="Digital Signature" class="max-h-16 max-w-48 object-contain" />
                      </div>
              ...
              <div class="booking-card bg-gradient-to-r from-blue-600/25 to-teal-600/25 border-2 border-blue-400/40 p-6 rounded-2xl backdrop-blur-sm hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-500 group">
                <div class="flex items-center space-x-4 mb-6">
                  <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-teal-600 rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 border border-blue-300/50">
                ...
                <form @submit.prevent="saveAssessment" class="space-y-6">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="group">
                      <label class="block text-sm font-semibold text-indigo-100 mb-2 flex items-center">
                        <i class="fas fa-search mr-2 text-indigo-300 text-sm"></i>
                        Device Condition Assessment <span class="text-red-400 ml-1">*</span>
                      </label>
                      <div class="relative">
                        <select 
                          ...
                          required
                        >
                          <option value="" class="bg-indigo-800 text-indigo-300">Select Condition</option>
                          <option value="good" class="bg-indigo-800 text-white">Good</option>
                          <option value="minor_issues" class="bg-indigo-800 text-white">Minor Issues</option>
                          <option value="needs_repair" class="bg-indigo-800 text-white">Needs Repair</option>
                        </select>
                        <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-indigo-300/50 pointer-events-none">
                          <i class="fas fa-chevron-down text-sm"></i>
                        </div>
                      </div>
                      <div v-if="errors.deviceCondition" class="text-red-400 text-xs mt-1 flex items-center">
                    ...
                    <div class="group">
                      ...
                      <div class="relative">
                        <select 
                          ...
                          required
                        >
                          <option value="" class="bg-indigo-800 text-indigo-300">Select Status</option>
                          <option value="pending" class="bg-indigo-800 text-white">Pending</option>
                          <option value="returned" class="bg-indigo-800 text-white">Returned</option>
                          <option value="compromised" class="bg-indigo-800 text-white">Compromised</option>
                        </select>
                        <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-indigo-300/50 pointer-events-none">
                          <i class="fas fa-chevron-down text-sm"></i>
                        </div>
                  ...
                  <div class="group">
                    ...
                    <div class="relative">
                      ...
                      ></textarea>
                      <div class="absolute inset-0 rounded-lg bg-gradient-to-r from-indigo-500/10 to-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                    </div>
                  </div>
    ...
    <div v-if="showSuccessModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-xl shadow-2xl max-w-lg w-full transform transition-all duration-300 scale-100 animate-modal-in">
        <div class="p-8 text-center">
          <div class="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <i class="fas fa-check text-green-600 text-3xl"></i>
          </div>
          <h3 class="text-2xl font-bold text-gray-800 mb-3">Assessment Saved Successfully!</h3>
          <p class="text-gray-600 mb-6">The device request assessment has been updated and saved to the system.</p>
          <button
