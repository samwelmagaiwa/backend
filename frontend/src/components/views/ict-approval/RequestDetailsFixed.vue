        ...
        <div class="max-w-full mx-auto px-4 relative z-10">
          ...
          <div class="booking-glass-card rounded-b-3xl overflow-hidden animate-slide-up">
            <div class="p-6 space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-purple-600/30">
                  ...
                  >
                    ...
                    {{
                      isSavingAssessment
                        ? 'Saving Assessment...'
                        : `Save ${assessmentType === 'issuing' ? 'Issuing' : 'Receiving'} Assessment`
                    }}
                  </button>
              ...
              <div
                v-if="canTakeAction"
                class="bg-green-800/30 backdrop-blur-sm rounded-xl p-6 border border-green-600/40"
              >
                <h3 class="text-lg font-bold text-white mb-4">ICT Officer Actions</h3>

                <div class="mb-4">
                  <label class="block text-sm font-semibold text-green-200 mb-2"
      ...
      async saveAssessment() {
        ...
        try {
          ...
          const assessmentData = {
            ...
            functionality:
              this.assessment.functionality === 'fully'
                ? 'fully_functional'
                : this.assessment.functionality === 'partially'
                  ? 'partially_functional'
                  : 'not_functional',
            accessories_complete: this.assessment.accessoriesComplete,
            visible_damage: this.assessment.hasDamage,
            damage_description: this.assessment.hasDamage
              ? this.assessment.damageDescription
              : null,
