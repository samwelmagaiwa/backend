                ...
                <div class="bg-gradient-to-r from-green-600/25 to-emerald-600/25 border-2 border-green-400/40 p-6 rounded-2xl backdrop-blur-sm hover:shadow-xl hover:shadow-green-500/20 transition-all duration-500">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <p class="text-2xl font-bold text-white">{{ stats.returned }}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-red-600/25 to-pink-600/25 border-2 border-red-400/40 p-6 rounded-2xl backdrop-blur-sm hover:shadow-xl hover:shadow-red-500/20 transition-all duration-500">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <p class="text-2xl font-bold text-white">{{ stats.compromised }}</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="bg-gradient-to-r from-blue-600/25 to-teal-600/25 border-2 border-blue-400/40 rounded-2xl backdrop-blur-sm overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    ...
                    <tbody class="divide-y divide-blue-300/20">
                      ...
                      >
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="flex items-center">
                            <div class="w-10 h-10 bg-gradient-to-br from-teal-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg mr-3">
                              <i class="fas fa-user text-white text-sm"></i>
                            </div>
                            <div>
                              <div class="text-sm font-medium text-white">{{ request.borrowerName }}</div>
                              <div class="text-sm text-blue-300">{{ request.phoneNumber }}</div>
                            </div>
                          </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="text-sm text-white">{{ request.department }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="flex items-center">
                            <i class="fas fa-laptop text-teal-300 mr-2"></i>
                            <span class="text-sm text-white">{{ getDeviceDisplayName(request.deviceType, request.customDevice) }}</span>
                          </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="text-sm text-white">{{ formatDate(request.bookingDate) }}</div>
                          <div class="text-xs text-blue-300">Return: {{ formatDate(request.collectionDate) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="flex items-center">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                          <div class="relative inline-block">
                            ...
                            >
                              ...
                              Actions
                              <i class="fas fa-chevron-down ml-2 text-xs transition-transform duration-200" :class="{ 'rotate-180': openDropdown === request.id }"></i>
                            </button>
                            ...
                            >
                              ...
                              >
                                ...
                                <button
                                  ...
                                  :class="{ 'opacity-50 cursor-not-allowed': request.status === 'cancelled' }"
                                >
                  ...
                  <div v-if="filteredRequests.length === 0" class="text-center py-12">
                    ...
                    <p class="text-blue-300">{{ searchQuery || statusFilter ? 'Try adjusting your filters' : 'No device borrowing requests have been submitted yet.' }}</p>
                  </div>
                </div>
    ...
    filteredRequests() {
      ...
      if (this.searchQuery) {
        ...
        filtered = filtered.filter(request => 
          ...
          this.getDeviceDisplayName(request.deviceType, request.customDevice).toLowerCase().includes(query)
        )
      }
