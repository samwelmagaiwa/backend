<template>
  <div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <main class="flex-1 p-6 bg-gradient-to-br from-blue-900 via-blue-800 to-teal-900 overflow-y-auto relative">
        ...
        <div class="max-w-6xl mx-auto relative z-10">
          <!-- Header Section -->
          <div class="booking-glass-card rounded-t-3xl p-6 mb-0 border-b border-blue-300/30 animate-fade-in">
            <div class="flex justify-between items-center">
              <!-- Left Logo -->
              <div class="w-24 h-24 mr-6 transform hover:scale-110 transition-transform duration-300">
                <div class="w-full h-full bg-gradient-to-br from-blue-500/20 to-teal-500/20 rounded-2xl backdrop-blur-sm border-2 border-blue-300/40 flex items-center justify-center shadow-2xl hover:shadow-blue-500/25">
                  <img src="/assets/images/ngao2.png" alt="National Shield" class="max-w-16 max-h-16 object-contain" />
                </div>
              </div>
              ...
              <div class="text-center flex-1">
                ...
                <h2 class="text-xl font-bold text-blue-100 tracking-wide drop-shadow-md animate-fade-in-delay">
                  ICT EQUIPMENT RESERVATION SYSTEM
                </h2>
              </div>
              
              <!-- Right Logo -->
              <div class="w-24 h-24 ml-6 transform hover:scale-110 transition-transform duration-300">
                <div class="w-full h-full bg-gradient-to-br from-teal-500/20 to-blue-500/20 rounded-2xl backdrop-blur-sm border-2 border-teal-300/40 flex items-center justify-center shadow-2xl hover:shadow-teal-500/25">
                  <img src="/assets/images/logo2.png" alt="Muhimbili Logo" class="max-w-16 max-h-16 object-contain" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="booking-glass-card rounded-b-3xl overflow-hidden animate-slide-up">
            <form @submit.prevent="submitBooking" class="p-8 space-y-8">
              ...
              <div class="booking-card bg-gradient-to-r from-teal-600/25 to-blue-600/25 border-2 border-teal-400/40 p-8 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-teal-500/20 transition-all duration-500 group">
                ...
                <div class="space-y-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="group">
                      <label class="block text-sm font-bold text-blue-100 mb-3 flex items-center">
                        <i class="fas fa-calendar mr-2 text-teal-300"></i>
                      ...
                      <div class="relative">
                        <input 
                          ...
                          type="date" 
                          class="booking-input w-full px-4 py-4 bg-white/15 border-2 border-blue-300/30 rounded-xl focus:border-teal-400 focus:outline-none text-white backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-teal-500/20 group-hover:border-teal-400/50"
                          required
                        />
                      ...
                      <div v-if="errors.bookingDate" class="text-red-400 text-xs mt-1 flex items-center">
                    ...
                    <div class="group">
                      ...
                      <div v-if="errors.borrowerName" class="text-red-400 text-xs mt-1 flex items-center">
                        <i class="fas fa-exclamation-circle mr-1"></i>
                        {{ errors.borrowerName }}
                      </div>
                    </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="group">
                      <label class="block text-sm font-bold text-blue-100 mb-3 flex items-center">
                        <i class="fas fa-laptop mr-2 text-teal-300"></i>
                      ...
                      <div class="relative">
                        <select 
                          ...
                          class="w-full px-4 py-4 border-2 border-blue-300/30 rounded-xl focus:border-teal-400 focus:outline-none text-white bg-blue-600/80 focus:bg-blue-600/90 transition-all backdrop-blur-sm group-hover:border-teal-400/50 appearance-none cursor-pointer"
                          required
                        >
                          <option value="" class="bg-blue-800 text-blue-300">Select Device Type</option>
                          <option value="projector" class="bg-blue-800 text-white">Projector</option>
                          <option value="tv_remote" class="bg-blue-800 text-white">TV Remote</option>
                          <option value="hdmi_cable" class="bg-blue-800 text-white">HDMI Cable</option>
                          <option value="monitor" class="bg-blue-800 text-white">Monitor</option>
                          <option value="cpu" class="bg-blue-800 text-white">CPU</option>
                          <option value="keyboard" class="bg-blue-800 text-white">Keyboard</option>
                          <option value="pc" class="bg-blue-800 text-white">PC</option>
                          <option value="others" class="bg-blue-800 text-white">Others</option>
                        </select>
                        <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-teal-300/50 pointer-events-none">
                          <i class="fas fa-chevron-down"></i>
                        </div>
                      </div>
                      <div v-if="errors.deviceType" class="text-red-400 text-xs mt-1 flex items-center">
                        <i class="fas fa-exclamation-circle mr-1"></i>
                        {{ errors.deviceType }}
                      </div>
                    </div>
                    ...
                    <div class="group">
                      ...
                      <div class="relative">
                        <select 
                          ...
                          class="w-full px-4 py-4 border-2 border-blue-300/30 rounded-xl focus:border-teal-400 focus:outline-none text-white bg-blue-100/20 focus:bg-blue-100/30 transition-all backdrop-blur-sm group-hover:border-teal-400/50 appearance-none cursor-pointer"
                          required
                        >
                      ...
                      <div v-if="errors.department" class="text-red-400 text-xs mt-1 flex items-center">
                        <i class="fas fa-exclamation-circle mr-1"></i>
                        {{ errors.department }}
                      </div>
                    </div>
                  ...
                  <div v-if="formData.deviceType === 'others'" class="group animate-slide-down">
                    <label class="block text-sm font-bold text-blue-100 mb-3 flex items-center">
                      <i class="fas fa-edit mr-2 text-teal-300"></i>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="group">
                      ...
                      <div v-if="errors.phoneNumber" class="text-red-400 text-xs mt-1 flex items-center">
                        <i class="fas fa-exclamation-circle mr-1"></i>
                        {{ errors.phoneNumber }}
                      </div>
                    ...
                    <div class="group">
                      <label class="block text-sm font-bold text-blue-100 mb-3 flex items-center">
                        <i class="fas fa-calendar-plus mr-2 text-teal-300"></i>
                      ...
                      <div v-if="errors.collectionDate" class="text-red-400 text-xs mt-1 flex items-center">
                        <i class="fas fa-exclamation-circle mr-1"></i>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="group">
                      <label class="block text-sm font-bold text-blue-100 mb-3 flex items-center">
                        <i class="fas fa-clock mr-2 text-teal-300"></i>
                      ...
                      <div v-if="errors.returnTime" class="text-red-400 text-xs mt-1 flex items-center">
                        <i class="fas fa-exclamation-circle mr-1"></i>
                        {{ errors.returnTime }}
                      </div>
                    </div>
                  ...
                  <div class="group">
                    <label class="block text-sm font-bold text-blue-100 mb-3 flex items-center">
                      <i class="fas fa-comment-alt mr-2 text-teal-300"></i>
                      Reason for Borrowing <span class="text-red-400 ml-1">*</span>
                    </label>
                    <div class="relative">
                      <textarea 
                        v-model="formData.reason" 
                        class="booking-input w-full px-2 py-2 bg-white/15 border-2 border-blue-300/30 rounded-xl focus:border-teal-400 focus:outline-none text-white placeholder-blue-200/60 backdrop-blur-sm transition-all duration-300 hover:bg-white/20 focus:bg-white/20 focus:shadow-lg focus:shadow-teal-500/20 group-hover:border-teal-400/50 resize-none"
                        rows="4"
              ...
              <div class="booking-card bg-gradient-to-r from-teal-600/25 to-blue-600/25 border-2 border-teal-400/40 p-8 rounded-2xl backdrop-blur-sm hover:shadow-2xl hover:shadow-teal-500/20 transition-all duration-500 group">
                <div class="flex items-center space-x-4 mb-6">
                  ...
                  <h3 class="text-xl font-bold text-white flex items-center">
                    <i class="fas fa-pen-fancy mr-2 text-teal-300"></i>
                    Digital Signature
                  </h3>
                </div>
                ...
                <div class="group">
                  ...
                  <div class="flex flex-col md:flex-row gap-4 items-start">
                    ...
                    <div class="relative w-full md:w-80 h-24 border-2 border-blue-300/30 rounded-xl bg-blue-100/20 focus-within:bg-blue-100/30 focus-within:border-teal-400 overflow-hidden backdrop-blur-sm group-hover:border-teal-400/50 transition-all duration-300">
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      <button
                        ...
                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-teal-500 to-blue-600 text-white text-sm font-medium rounded-xl hover:from-teal-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-1 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105 border border-teal-400/30"
                      >
                      ...
                      <p class="text-xs text-emerald-200/70 italic flex items-center">
                        <i class="fas fa-info-circle mr-1"></i>
                        Max size: 2MB
                      </p>
                    </div>
              ...
              <!-- Submit Section -->
              <div class="border-t border-blue-300/20 pt-8">
                <div class="text-center mb-6">
                  <div class="inline-block bg-white/10 backdrop-blur-sm px-6 py-4 rounded-2xl border border-blue-300/40 shadow-lg">
                    <p class="font-bold text-xl text-white mb-1">ICT Department</p>
                    <p class="text-sm text-blue-200/80">Device Booking & Management System</p>
                  </div>
                </div>
                ...
                <div class="flex justify-between items-center">
                  <button
                    type="button"
                    @click="goBack"
                    class="px-8 py-4 bg-gray-600/80 text-white rounded-xl hover:bg-gray-700/80 transition-all duration-300 font-semibold flex items-center shadow-lg hover:shadow-xl transform hover:scale-105 backdrop-blur-sm border border-gray-500/50"
                  >
    ...
    <div v-if="showSuccessModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-xl shadow-2xl max-w-md w-full transform transition-all duration-300 scale-100 animate-modal-in">
        <div class="p-6 text-center">
          <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <i class="fas fa-check text-green-600 text-2xl"></i>
          </div>
          <h3 class="text-xl font-bold text-gray-800 mb-2">Booking Submitted Successfully!</h3>
          <p class="text-gray-600 mb-4">Your device booking request has been submitted and is now under review.</p>
          ...
          <button
            ...
            class="w-full bg-teal-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition duration-200"
          >
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      if (this.formData.deviceType === 'others' && !this.formData.customDevice.trim()) {
      ...
      if (!this.formData.conditionBefore) {
        this.errors.conditionBefore = 'Device condition before taken is required'
      }

      if (this.formData.conditionBefore === 'something_not_good' && !this.formData.conditionBeforeIssues.trim()) {
        this.errors.conditionBeforeIssues = 'Please describe what\'s wrong'
      }

      if (!this.formData.conditionReturned) {
        this.errors.conditionReturned = 'Device condition returned is required'
      }

      if (this.formData.conditionReturned === 'compromised' && !this.formData.conditionReturnedIssues.trim()) {
        this.errors.conditionReturnedIssues = 'Please describe what\'s wrong with the device'
      }
