            ...
            >
              ...
              <div class="py-2">
                ...
                >
                  ...
                  <div class="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-blue-700/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                >
                  ...
                  <div class="relative z-10">
                    ...
                    <p class="text-xs text-blue-100 drop-shadow-sm">Reset Terms & ICT Policy per user</p>
                  </div>
                </button>
                ...
                >
                  <!-- Multi-layer hover effects -->
                  <div class="absolute inset-0 bg-gradient-to-r from-red-500/20 to-red-700/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div class="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div
